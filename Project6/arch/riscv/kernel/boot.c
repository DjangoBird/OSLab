...
/* Sv-39 mode
 * 0x0000_0000_0000_0000-0x0000_003f_ffff_ffff is for user mode    低地址用户
 * 0xffff_ffc0_0000_0000-0xffff_ffff_ffff_ffff is for kernel mode  高地址内核
 */
static void ARRTIBUTE_BOOTKERNEL setup_vm()
{
    ...
    //临时等值映射
    // map boot address
    for (uint64_t pa = 0x50000000lu; pa < 0x52000000lu;
         pa += 0x200000lu) {
